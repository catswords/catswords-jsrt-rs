...
Inspired by [@darfink’s chakracore-rs implementation](https://github.com/darfink/chakracore-rs?utm_source=catswords) (not a fork), which is no longer maintained. This workspace is a clean reimplementation.
